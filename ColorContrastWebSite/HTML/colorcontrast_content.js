...
tocTab[ir++] = new Array ("1.2", "Quick Instructions", "secondtopic.htm", "", "cicon9.gif", "cicon9.gif");
tocTab[ir++] = new Array ("2", "Chapter 2", "", "", "cicon1.gif", "cicon2.gif");
tocTab[ir++] = new Array ("2.1", "Overview", "overview.htm", "", "cicon9.gif", "cicon9.gif");
tocTab[ir++] = new Array ("2.2", "Sub chapter 2.1", "", "", "cicon1.gif", "cicon2.gif");
tocTab[ir++] = new Array ("2.2.1", "New topic", "newtopic.htm", "", "cicon9.gif", "cicon9.gif");
isContent = true,
isIndex = false,
showNumbers = false,
...
function windowErr() {
isDyn = false;
hmtoc.location.href = "colorcontrast_content.htm";
window.onerror = oldOnError;
}
function reDisplay(currentNumber,tocChange,noLink,e) {
if (isIndex && (hmtoc.location.href.substring(hmtoc.location.href.lastIndexOf("/")+1,hmtoc.location.href.length) != "colorcontrast_kwindex.htm")) { isIndex=false; isContent=true; }
...
if (isContent && isDyn) {
hmtoc.document.write("\n\r\n\r<hr><font face=\"Arial,Helvetica\" size=\"1\">&copy; 2015 ... Horia Tudosie</font>\n\r</body>\n\r</html>\n\r");
